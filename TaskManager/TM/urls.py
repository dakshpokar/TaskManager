...
from TM.views import LoginView, RegisterView, DashboardView, CreateTeamView, logout_view, TeamView, SettingsView, ProfileView, SpecificTeamView, CreateTaskView, DeleteTasks, TasksView, DeleteTeam, MembersView, TeamSettingsView
